...
chrome.runtime.onMessage.addListener(({ method, minLength, maxLength }) => {
  if (method === "renderHighlights") {
    renderHighlights(Number(minLength), Number(maxLength));
  }
  if (method === "removeHighlights") {
    removeHighlights();
  }
});
